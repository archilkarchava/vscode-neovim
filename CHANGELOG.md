...
## [1.11.4](https://github.com/archilkarchava/vscode-neovim/compare/v1.17.0...v1.11.4) (2024-06-13)
...
* add $NVIM_APPNAME option ([#1186](https://github.com/archilkarchava/vscode-neovim/issues/1186)) ([5b54212](https://github.com/archilkarchava/vscode-neovim/commit/5b5421201701be67fc92d42b39fb049708b4d0f1))
...
* **bindings:** global window navigations ([#1248](https://github.com/archilkarchava/vscode-neovim/issues/1248)) ([88103a8](https://github.com/archilkarchava/vscode-neovim/commit/88103a83010f57a24acf506610d4a89c7019aa20))
...
* **bindings:** support &lt;c-t&gt; as navigateBack ([#827](https://github.com/archilkarchava/vscode-neovim/issues/827)) ([1cd8afb](https://github.com/archilkarchava/vscode-neovim/commit/1cd8afb8401ee13d398ec836d990a97bee3ec7bc))
* **bindings:** z fold bindings for lists (incl. files explorer) ([#1250](https://github.com/archilkarchava/vscode-neovim/issues/1250)) ([a86bd36](https://github.com/archilkarchava/vscode-neovim/commit/a86bd36a062184be2a8739d88d50053cb53763f4))
...
* **ci:** add automatic releases ([#1244](https://github.com/archilkarchava/vscode-neovim/issues/1244)) ([0bcee88](https://github.com/archilkarchava/vscode-neovim/commit/0bcee88bbdb746a64fb58204a605797fdbdd14da))
...
* **command line:** add a configurable completion timer delay ([#1467](https://github.com/archilkarchava/vscode-neovim/issues/1467)) ([0cb897c](https://github.com/archilkarchava/vscode-neovim/commit/0cb897c0d7805dafad5967602534a2f8b61ffadf))
...
* **lua:** Add "vscode.with_insert" ([#2055](https://github.com/archilkarchava/vscode-neovim/issues/2055)) ([be8812f](https://github.com/archilkarchava/vscode-neovim/commit/be8812f7fbdc20917e18d844507001f2b347a07e))
...
* **main:** add options.lua ([#1254](https://github.com/archilkarchava/vscode-neovim/issues/1254)) ([504d462](https://github.com/archilkarchava/vscode-neovim/commit/504d46249f81351f8131109cb430e70424c0adb3))
* **mode:** switch to `ModeChanged` for more detailed mode information ([#1255](https://github.com/archilkarchava/vscode-neovim/issues/1255)) ([97140a7](https://github.com/archilkarchava/vscode-neovim/commit/97140a735b97d172bfb8c02a95def0d1675a232b))
...
* [#1531](https://github.com/archilkarchava/vscode-neovim/issues/1531) ([deb41d4](https://github.com/archilkarchava/vscode-neovim/commit/deb41d463de8d04453f1ca5e2b8acf6393e7464a))
...
* **bindings:** {count}gt command not jumping to correct tab [#670](https://github.com/archilkarchava/vscode-neovim/issues/670) ([a2c9b03](https://github.com/archilkarchava/vscode-neovim/commit/a2c9b03bd995f941b16278a4f9ea402e8b9c063d))
...
* **change:** Fix bug in setting applyingEdits variable ([8f6447c](https://github.com/archilkarchava/vscode-neovim/commit/8f6447c362b97fa12c3147a897b8714cfa846391))
...
* **cursor:** re-add new VSCodeNotifyRange impl ([#1358](https://github.com/archilkarchava/vscode-neovim/issues/1358)) ([368c58d](https://github.com/archilkarchava/vscode-neovim/commit/368c58db5fe5b6ae2bca37df3d6cfeb2fb98d62e))
...
* don't debounce cursor position updates ([bd52dae](https://github.com/archilkarchava/vscode-neovim/commit/bd52dae18d33b7ab75f6fbdef2571bd0a448e024))
* don't debounce cursor position updates ([64a1b7e](https://github.com/archilkarchava/vscode-neovim/commit/64a1b7e7c18b3bc0d4724b326af744dcab7132e4))
...
* highlight calculations race with buffer updates ([#1890](https://github.com/archilkarchava/vscode-neovim/issues/1890)) ([53acfe5](https://github.com/archilkarchava/vscode-neovim/commit/53acfe564012b9b1a20563d665791a8f28f810d5))
...
* **incsearch:** viewport is not updating during searching ([#1575](https://github.com/archilkarchava/vscode-neovim/issues/1575)) ([b8696a3](https://github.com/archilkarchava/vscode-neovim/commit/b8696a396c5ddffd0848f30a2c785aa05c2ca79a))
...
* **mode:** cmdline mode bindings [#1298](https://github.com/archilkarchava/vscode-neovim/issues/1298) ([#1299](https://github.com/archilkarchava/vscode-neovim/issues/1299)) ([6f4b9a0](https://github.com/archilkarchava/vscode-neovim/commit/6f4b9a0ecb5a5d53a239c8c398eb41c066e9e44c))
...
* redraw events are processed in order ([#1940](https://github.com/archilkarchava/vscode-neovim/issues/1940)) ([122eb56](https://github.com/archilkarchava/vscode-neovim/commit/122eb56c9bd00570ea58b1da778fddb670437ae9))
...
* update expected cursor when multiple docs change ([#2035](https://github.com/archilkarchava/vscode-neovim/issues/2035)) ([504da9e](https://github.com/archilkarchava/vscode-neovim/commit/504da9eb1516c7890cf00d50b6916fd4c6578008))
...
* wrong VSCode selections if cursor is at start of selection [#1180](https://github.com/archilkarchava/vscode-neovim/issues/1180) ([f9bcd25](https://github.com/archilkarchava/vscode-neovim/commit/f9bcd2555c01ad238d9eca06f1c051c43ee71b15))
...
* fix broken link for 0.10 compat ([#2094](https://github.com/archilkarchava/vscode-neovim/issues/2094)) ([8f95e4f](https://github.com/archilkarchava/vscode-neovim/commit/8f95e4f0f6d20dfd3b6b7c5ee6c44c4d66a1b1cd))
...
* **readme:** fix visual studio marketplace badge [#1127](https://github.com/archilkarchava/vscode-neovim/issues/1127) ([fd152cf](https://github.com/archilkarchava/vscode-neovim/commit/fd152cf8d539e3ae28a566d9aad6bca05208755f))
...
* init output channels in the corresponding manager ([#2053](https://github.com/archilkarchava/vscode-neovim/issues/2053)) ([927ed95](https://github.com/archilkarchava/vscode-neovim/commit/927ed955d9075f40bb5f2f40d2ad9e057f13906c))
...
* remove Altercmd for "write" ([#2027](https://github.com/archilkarchava/vscode-neovim/issues/2027)) ([6a73cc2](https://github.com/archilkarchava/vscode-neovim/commit/6a73cc219855f41b4c3669d4de0f19d7477cbd24))
